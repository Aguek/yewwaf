...
class OrderScreenForRegularOffers extends StatefulWidget {
  final String link;
  ...
  @override
  _OrderScreenForRegularOffersState createState() =>
      _OrderScreenForRegularOffersState();
}
...
class _OrderScreenForRegularOffersState
    extends State<OrderScreenForRegularOffers> {
...
//method to get the position of the user
  ...
  Widget build(BuildContext context) {
    var parsedPrice = int.parse(widget.offerPrice);
                ...
                Card(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Deliver cost: SSP ' + getTransportCost().toString(),
                        style: TextStyle(
                    ...
                    child: Platform.isIOS
                      ...
                      decoration: InputDecoration(
                        ...
                        focusedBorder: OutlineInputBorder(
                          borderSide:
                              BorderSide(color: Colors.black26, width: 5.0),
